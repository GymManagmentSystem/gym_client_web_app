...
const nameText={ 
  ...
  fontWeight:'bold',mt:1,mb:2
}
const setsBoxHstackStyles={
  alignItems:'center', justifyContent:'center',mt:1 ,spacing:{base:5,md:8,lg:10,xl:10}
}
const setsBoxStyles = {
  bg: '#fff',
...
const setsValue=
{color:'#000',fontSize:{base: "12px", md: "14px", lg: "16px", xl: "16px"} }

const checkboxHstack={
  spacing:{base:5,md:8,lg:10,xl:10}, alignItems:'center', justifyContent:'center', mt:{base:3,md:5,lg:5,xl:5}
}
